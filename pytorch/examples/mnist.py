...
def get_mnist(data_dir):
    x_train = load(data_dir + "train-images-idx3-ubyte.gz", image=True)
    y_train = load(data_dir + "train-labels-idx1-ubyte.gz", image=False)
    x_test = load(data_dir + "t10k-images-idx3-ubyte.gz", image=True)
    y_test = load(data_dir + "t10k-labels-idx1-ubyte.gz", image=False)
