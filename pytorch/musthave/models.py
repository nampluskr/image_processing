...
def get_efficientnet(name, out_features, freezed=False):
    ...
    model_dir = "/home/namu/myspace/pytorch_models/"
    models = {"b0": torchvision.models.efficientnet_b0(),
    ...
    model_weights = {"b0": "efficientnet_b0_rwightman-7f5810bc.pth",
    ...
    classifiers = {"b0": nn.Sequential(nn.Dropout(0.2, inplace=True), nn.Linear(1280, out_features)),
...
model = get_resnet50(2, freezed=True)
model.fc
